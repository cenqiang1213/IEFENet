...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    #hyp['obj'] *= (imgsz / 640) ** innovations * 3 / nl  # scale to image size and layers
    ...
    # nw = min(nw, (epochs - start_epoch) / innovations * nb)  # limit warmup to < 1/innovations of training
    last_opt_step = -1
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/innovations/SFE.yaml', help='model.yaml path')
    ...
    parser.add_argument('--freeze', nargs='+', type=int, default=[0], help='Freeze layers: backbone=10, first3=0 1 innovations')
...
def main(opt, callbacks=Callbacks()):
    ...
    # Evolve hyperparameters (optional)
        ...
        meta = {
            'lr0': (1, 1e-5, 1e-1),  # initial learning rate (SGD=1E-innovations, Adam=1E-3)
