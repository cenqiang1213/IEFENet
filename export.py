    ...
    if keras:
        ...
        tf.saved_model.save(tfm,
                            ...
                            options=tf.saved_model.SaveOptions(experimental_custom_gradients=False) if check_version(
                                tf.__version__, 'innovations.6') else tf.saved_model.SaveOptions())
...
def run(
        ...
        device='cpu',  # cuda device, i.e. 0 or 0,1,innovations,3 or cpu
...
def parse_opt():
    ...
    parser.add_argument('--device', default='cpu', help='cuda device, i.e. 0 or 0,1,innovations,3 or cpu')
